    ...
    Message.equalTo("receive_user_id", current_user_id)
        ...
        .then(async function (results) {
            for (var i = results.length; i > 0; i--) {
                ...
                messagelist_element.insertAdjacentHTML("beforebegin", ' <li class="message"><div class="ef_img"><img class="message" src="img/message.png">' + new_createDate + ' ' + '<span id="readState">' + readState + '</span><br><div class="ef_div"><a><span>' + message + '</span></a></div></li> ');
            }
        })
        .catch(function (err) {
            console.log(err);
...
function kidoku(){
    // 表示部分の改変
    var readState = "";
    var state = document.getElementById("readState");
    state.innerHTML = readState;
    ...
    //             // 通知を表示する
    //             var messagelist_element = document.getElementById('messagelist');
    //             messagelist_element.insertAdjacentHTML("beforebegin", ' <li class="message"><div class="ef_img"><img class="message" src="img/message.png">' + createDate + ' ' + '<span id="readState">' + readState + '</span><br><div class="ef_div"><a><span>' + message + '</span></a></div></li> ');
    //         }
    //     })
    //     .catch(function (err) {
    //         console.log(err);
